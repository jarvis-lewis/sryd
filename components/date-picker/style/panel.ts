    ...
    [componentCls]: {
      ...
      "&-content": {
        ...
        th: {
          height: token
            .calc(cellHeight)
            .add(token.calc(pickerCellPaddingVertical).mul(2))
            .equal(),
          color: colorText,
          ...
          "&-range-start td, &-range-end td, &-selected td, &-hover td": {
            ...
            [`&${pickerCellCls}`]: {
              ...
              [`&${componentCls}-cell-week`]: {
                color: new TinyColor(colorTextLightSolid)
                  .setAlpha(0.5)
                  .toHexString(),
              },
      ...
      "&-time-panel": {
        ...
        "&-column": {
          ...
          "&-active": {
            background: new TinyColor(controlItemBgActive)
              .setAlpha(0.2)
              .toHexString(),
          },
          ...
          "> li": {
            ...
            [`&${componentCls}-time-panel-cell`]: {
              ...
              [`${componentCls}-time-panel-cell-inner`]: {
                display: "block",
                width: token
                  .calc(timeColumnWidth)
                  .sub(token.calc(marginXXS).mul(2))
                  .equal(),
    ...
    [`${componentCls}-dropdown`]: {
      ...
      [`${componentCls}-footer`]: {
        ...
        "&-extra": {
          ...
          lineHeight: unit(
            token.calc(textHeight).sub(token.calc(lineWidth).mul(2)).equal(),
          ),
          textAlign: "start",
