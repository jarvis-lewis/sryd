...
describe("RangePicker", () => {
  ...
  it("RangePicker picker quarter placeholder", () => {
    const { container } = render(
      <RangePicker picker="quarter" locale={enUS} />,
    );
    expect(container.querySelectorAll("input")[0]?.placeholder).toEqual(
      "Start quarter",
    );
    expect(container.querySelectorAll("input")[1]?.placeholder).toEqual(
      "End quarter",
    );
  });
