...
import { CloseCircleFilled } from "@sryd/icons";
...
describe("DatePicker", () => {
  ...
  it("prop locale should works", () => {
    ...
    const wrapper = render(
      <DatePicker open locale={locale as PickerLocale} value={birthday} />,
    );
  ...
  it("placeholder", () => {
    ...
    expect(wrapper.container.querySelector("input")?.placeholder).toEqual(
      "Select date",
    );
  });
  ...
  it("showTime={{ showHour: true, showMinute: true }}", () => {
    ...
    expect(
      container.querySelectorAll(".ant-picker-time-panel-column").length,
    ).toBe(2);
    expect(
      container
  ...
  it("showTime={{ }} (no true args)", () => {
    ...
    expect(
      container.querySelectorAll(".ant-picker-time-panel-column"),
    ).toHaveLength(3);
  });
  ...
  it("DatePicker.RangePicker with defaultValue and showTime", () => {
    ...
    const y = container.querySelector(
  ...
  it("RangePicker placement api work correctly", () => {
    const { rerender } = render(
      <DatePicker.RangePicker open placement="topLeft" />,
    );
  ...
  it("legacy dropdownClassName", () => {
    ...
    const { container } = render(
      <DatePicker dropdownClassName="legacy" open />,
    );
  ...
  it("allows or prohibits clearing as applicable", async () => {
    ...
    expect(getClearButton()).toBeTruthy();
    expect(
      container.querySelector('[data-testid="custom-clear"]'),
    ).toBeTruthy();
