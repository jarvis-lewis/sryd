...
import { ClockCircleOutlined, DownOutlined } from "@sryd/icons";
import {
  Anchor,
  Badge,
  Button,
...
import type { TableProps, TransferProps } from "sryd";
...
const expandDataSource = Array.from({ length: 3 }).map<ExpandDataType>(
  (_, i) => ({
    key: i,
...
const TableTransfer: React.FC<
  Readonly<
    Partial<
      Record<"leftColumns" | "rightColumns", TableProps<DataType>["columns"]>
    >
  > &
