...
describe("Layout", () => {
  ...
  it("detect the sider as children", () => {
    ...
    expect(
      container
        .querySelector(".ant-layout")
        ?.className.includes("ant-layout-has-sider"),
    ).toBe(true);
    unmount();
  });
  ...
  it("should have 50% width of sidebar", async () => {
    ...
    expect(
      container.querySelector<HTMLElement>(".ant-layout-sider")?.style.flex,
    ).toBe("0 0 50%");
  });
  ...
  it("detect ant-layout-sider-dark as default theme", async () => {
    ...
    expect(
      container
        .querySelector(".ant-layout-sider")
        ?.className.includes("ant-layout-sider-dark"),
    ).toBe(true);
  });
  ...
  it("detect ant-layout-sider-light when set light theme", async () => {
    ...
    expect(
      container
        .querySelector(".ant-layout-sider")
        ?.className.includes("ant-layout-sider-light"),
    ).toBe(true);
  });
