...
const genDirectionStyle = (
  ...
  const railPadding: keyof React.CSSProperties = horizontal
    ? "paddingBlock"
    : "paddingInline";
  const full: keyof React.CSSProperties = horizontal ? "width" : "height";
  const part: keyof React.CSSProperties = horizontal ? "height" : "width";
  const handlePos: keyof React.CSSProperties = horizontal
    ? "insetBlockStart"
    : "insetInlineStart";
  const markInset: keyof React.CSSProperties = horizontal
    ? "top"
    : "insetInlineStart";
