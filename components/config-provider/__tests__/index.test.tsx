...
describe("ConfigProvider", () => {
  ...
  it("autoInsertSpaceInButton", () => {
    ...
    expect(container.querySelector<HTMLSpanElement>("span")?.innerHTML).toBe(
      text,
    );
  });
  ...
  it("renderEmpty", () => {
    ...
    expect(
      container.querySelector(".ant-table-placeholder")?.querySelector("div")
        ?.innerHTML,
    ).toBe(text);
  });
  ...
  it("select showSearch", () => {
    ...
    expect(container.querySelectorAll(".ant-select-show-search").length).toBe(
      1,
    );
  });
  ...
  it("warning support filter level", () => {
    ...
    render(
      <ConfigProvider dropdownMatchSelectWidth warning={{ strict: false }} />,
    );
  ...
  it("should support variant", () => {
    ...
    expect(container.querySelector("#variant-input-1")).toHaveClass(
      "ant-input-filled",
    );
    expect(container.querySelector("#variant-input-2")).toHaveClass(
      "ant-input-outlined",
    );
    expect(container.querySelector("#variant-input-3")).toHaveClass(
      "ant-input-borderless",
    );
    expect(container.querySelector("#variant-input-4")).toHaveClass(
      "ant-input-filled",
    );
    expect(container.querySelector("#variant-input-5")).toHaveClass(
      "ant-input-filled",
    );
    expect(container.querySelector("#variant-input-6")).toHaveClass(
      "ant-input-outlined",
    );
  });
});
