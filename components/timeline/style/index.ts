    ...
    [componentCls]: {
      ...
      [`${componentCls}-item`]: {
        ...
        "&-tail": {
          ...
          insetInlineStart: calc(calc(token.itemHeadSize).sub(token.tailWidth))
            .div(2)
            .equal(),
        ...
        "&-content": {
          position: "relative",
          insetBlockStart: calc(
            calc(token.fontSize).mul(token.lineHeight).sub(token.fontSize),
          )
            .mul(-1)
            .add(token.lineWidth)
            .equal(),
        ...
        [`${componentCls}-item-right`]: {
          [`${componentCls}-item-tail,
            ...
            insetInlineStart: `calc(100% - ${unit(
              calc(calc(token.itemHeadSize).add(token.tailWidth))
                .div(2)
                .equal(),
            )})`,
          },
