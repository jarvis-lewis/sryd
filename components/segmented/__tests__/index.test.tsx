...
describe("Segmented", () => {
  ...
  it("render label with ReactNode", () => {
    ...
    expect(container.querySelector(".little")?.textContent).toContain(
      "Monthly",
    );
  });
  ...
  it("render segmented with options: disabled", () => {
    ...
    expect(
      container.querySelectorAll(`.${prefixCls}-item-input`)[1],
  ...
  it("render segmented: disabled", () => {
    ...
    expect(
      container
        .querySelectorAll(`.${prefixCls}`)[0]
        .classList.contains(`${prefixCls}-disabled`),
    ).toBeTruthy();
  ...
  it("render segmented with options null/undefined", () => {
    ...
    expect(asFragment().firstChild).toMatchSnapshot();
    expect(
      Array.from(container.querySelectorAll(`.${prefixCls}-item-label`)).map(
        (n) => n.textContent,
      ),
    ).toEqual(["", "", ""]);
  });
  ...
  it("render segmented with `block`", () => {
    ...
    expect(
      container
        .querySelectorAll(`.${prefixCls}`)[0]
        .classList.contains(`${prefixCls}-block`),
    ).toBeTruthy();
  });
  ...
  it("render segmented with `size#small`", () => {
    ...
    expect(
      container
        .querySelectorAll(`.${prefixCls}`)[0]
        .classList.contains(`${prefixCls}-sm`),
    ).toBeTruthy();
  });
  ...
  it("render segmented with `size#large`", () => {
    ...
    expect(
      container
        .querySelectorAll(`.${prefixCls}`)[0]
        .classList.contains(`${prefixCls}-lg`),
    ).toBeTruthy();
  });
  ...
  it("render with icons", () => {
    ...
    expect(asFragment().firstChild).toMatchSnapshot();
    expect(
      container.querySelectorAll(`span.${prefixCls}-item-icon`).length,
    ).toBe(2);
    expect(
      container
