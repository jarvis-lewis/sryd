...
const genInputNumberStyles: GenerateStyle<InputNumberToken> = (
...
const genAffixWrapperStyles: GenerateStyle<InputNumberToken> = (
  token: InputNumberToken,
) => {
  const {
    componentCls,
...
export default genStyleHooks(
  "InputNumber",
  (token) => {
    const inputNumberToken = mergeToken<InputNumberToken>(
      token,
