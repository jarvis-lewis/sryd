...
const genCardStyle: GenerateStyle<TabsToken> = (
  token: TabsToken,
): CSSObject => {
  const {
    componentCls,
...
const genDropdownStyle: GenerateStyle<TabsToken> = (
  token: TabsToken,
): CSSObject => {
...
const genPositionStyle: GenerateStyle<TabsToken> = (
  token: TabsToken,
): CSSObject => {
  const {
    componentCls,
...
const genSizeStyle: GenerateStyle<TabsToken> = (
  token: TabsToken,
): CSSObject => {
  const {
    componentCls,
...
const genTabsStyle: GenerateStyle<TabsToken> = (
  token: TabsToken,
): CSSObject => {
  const {
    componentCls,
