...
describe('Tabs', () => {
  ...
  it('warning for onNextClick', () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith(
      'Warning: [sryd: Tabs] `onPrevClick` and `onNextClick` has been removed. Please use `onTabScroll` instead.',
    );
  ...
  it('deprecated warning', () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith(
      'Warning: [sryd: Tabs] `Tabs.TabPane` is deprecated. Please use `items` instead.',
    );
    errorSpy.mockRestore();
  });
  ...
  it('warning for indicatorSize', () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith(
      'Warning: [sryd: Tabs] `indicatorSize` has been deprecated. Please use `indicator={{ size: ... }}` instead.',
    );
    errorSpy.mockRestore();
  });
});
