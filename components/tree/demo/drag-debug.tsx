...
import { CarryOutOutlined } from "@sryd/icons";
import type { TreeDataNode, TreeProps } from "sryd";
import { Switch, Tree } from "sryd";
  ...
  return (
    <>
      <div style={{ marginBottom: 16 }}>
        ...
        <br />
        showLeafIcon:{" "}
        <Switch checked={showLeafIcon} onChange={innerSetShowLeafIcon} />
      </div>
      <Tree
        showLine={showLine}
        showIcon={showIcon}
