...
import type { CSSObject } from "@sryd/cssinjs";
...
const genPaginationDisabledStyle: GenerateStyle<PaginationToken, CSSObject> = (
  token,
) => {
...
const genPaginationMiniStyle: GenerateStyle<PaginationToken, CSSObject> = (
  token,
) => {
  const { componentCls } = token;
...
const genPaginationSimpleStyle: GenerateStyle<PaginationToken, CSSObject> = (
  token,
) => {
  const { componentCls } = token;
...
const genPaginationJumpStyle: GenerateStyle<PaginationToken, CSSObject> = (
  token,
) => {
  const { componentCls } = token;
...
const genPaginationItemStyle: GenerateStyle<PaginationToken, CSSObject> = (
  token,
) => {
  const { componentCls } = token;
...
const genPaginationStyle: GenerateStyle<PaginationToken, CSSObject> = (
  token,
) => {
  const { componentCls } = token;
...
export const prepareComponentToken: GetDefaultToken<"Pagination"> = (
  token,
) => ({
