...
const {
  _InternalPanelDoNotUseOrYouWillBeFired: ModalDoNotUseOrYouWillBeFired,
} = Modal;
const {
  _InternalPanelDoNotUseOrYouWillBeFired: DatePickerDoNotUseOrYouWillBeFired,
} = DatePicker;
const { _InternalPanelDoNotUseOrYouWillBeFired: TourDoNotUseOrYouWillBeFired } =
  Tour;
const {
  _InternalPanelDoNotUseOrYouWillBeFired: FloatButtonDoNotUseOrYouWillBeFired,
} = FloatButton;
