...
import Icon, * as AntdIcons from "@sryd/icons";
...
const IconSearch: React.FC = () => {
  ...
  const handleSearchIcon = debounce(
  ...
  const [searchBarAffixed, setSearchBarAffixed] = useState<boolean | undefined>(
    false,
  );
  ...
  return (
    <div className="markdown">
      <Affix offsetTop={anchorTop} onChange={setSearchBarAffixed}>
        <div
          className={styles.iconSearchAffix}
