...
const locales = {
  ...
  en: {
    ...
    customizeComponentTokenLink:
      "docs/react/customize-theme#customize-component-token",
  },
};
...
const SubTokenTable: React.FC<SubTokenTableProps> = (props) => {
  const { defaultOpen, tokens, title, helpText, helpLink, component, comment } =
    props;
  ...
  const [open, setOpen] = useState<boolean>(
    defaultOpen ?? process.env.NODE_ENV !== "production",
  );
...
const ComponentTokenTable: React.FC<ComponentTokenTableProps> = ({
  component,
}) => {
